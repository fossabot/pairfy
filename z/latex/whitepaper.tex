...
The transaction commission must comply with these principles: It must always benefit the buyer more than the seller. It must not be repulsive. It must be lower than that of the competition. It must be reported to the user. Therefore, if 10,000 transactions occur with commissions of 0.5 ADA, then 2,500 ADA can go to discounts returning to users and 2,500 ADA to pay for technological infrastructure and mediators. All paid from the liquidity pool.
